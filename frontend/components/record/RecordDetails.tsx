  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-x-20 gap-y-4 mt-12 px-12 lg:px-4">
        <div className="">
          <div className="">
            <Link href={`/record/update/${record.id}`} className="flex items-center justify-center mx-12 md:mx-40 lg:mx-0 xl:mx-12 rounded-full p-4 bg-red-100 hover:bg-red-300 hover:text-white">
            <svg
        ...
        <div className="">
          <div className="flex items-center justify-center mx-12 md:mx-40 lg:mx-0 xl:mx-12 rounded-full p-4 cursor-pointer bg-red-100 hover:bg-red-300 text-black hover:text-white" onClick={() => deleteRecordHandler(record.id)}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="22"
              height="22"
        ...
        <div className="">
          <div className="">
            <Link href="/my-records" className="flex items-center justify-center mx-12 md:mx-40 lg:mx-0 xl:mx-12 rounded-full p-4 cursor-pointer bg-red-100 hover:bg-red-300 text-black hover:text-white">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
