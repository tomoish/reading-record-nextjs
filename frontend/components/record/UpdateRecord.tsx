...
const UpdateRecord = ({
  ...
  return (
    <>
      ...
      <Link
        href="/my-records"
        className="flex justify-center items-center rounded-full w-3/5 md:w-2/5 xl:w-1/4 m-auto mt-8 p-4 bg-red-100 hover:bg-red-300 hover:text-white"
      >
        <svg
        ...
        <span className="ml-4 text-lg">Back to my records</span>
      </Link>
    </>
  );
};
